...
manifested through computation expressions in F#.
  ...
  * [Programming Model (Core)](programming-model.html) An overview of the MBrace.Core programming model.

  * [Programming Model and Deployment (Azure)](azure-tutorial.html) Getting started with MBrace on Windows Azure.
